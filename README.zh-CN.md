...
[English](./README.md) | [🇪🇸 Español](./README.es.md) | [🇫🇷 Français](./README.fr.md) | [🇸🇦 العربية](./README.ar.md) | [🇮🇳 हिन्दी](./README.hi.md)
...
| `--since` / `--until` | 自定义日期 (YYYY-MM-DD) | - |
| `--orgs` | 逗号分隔的组织名称 | 无 |
| `--personal-limit` | 扫描的个人仓库上限 | 20 |
| `--org-limit` | 每个组织扫描的仓库上限 | 50 |
